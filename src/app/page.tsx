      ...
      <section className="relative h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Welcome to Bujwang'a Mixed Secondary School
          </h1>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/contact"
              className="bg-transparent border-2 border-white hover:bg-white hover:text-blue-600 px-8 py-3 rounded-full text-lg font-semibold transition-colors"
            >
              Contact Us
            </Link>
          </div>
...
const features = [
  ...
  },
  {
    ...
    description:
      'We celebrate diversity and foster an inclusive environment where every student feels valued.',
  },
  {
    icon: (
      <svg
    ...
    description:
      'State-of-the-art classrooms, laboratories, and sports facilities to enhance learning.',
  },
];
